...
export class Database extends cdk.Stack {
    ...
    constructor(scope: cdk.Construct, id: string, props: DatabaseProps) {
        ...
        // TODO: remove when the Bhojpur.NET Platform helm chart supports using secrets from ssm
        this.credentials = ssm.StringParameter.valueForStringParameter(
            this, `/bhojpur/cluster/${props.clusterName}/region/${props.vpc.stack.region}`);

        const instance = new rds.DatabaseInstance(this, 'Bhojpur', {
            vpc: props.vpc,

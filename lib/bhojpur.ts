...
export interface BhojpurProps extends StackProps {
    domain: string

    certificateArn?: string
}

export class BhojpurStack extends Stack {
    constructor(scope: Construct, id: string, props: BhojpurProps) {
        ...
        // if we have a AWS Route53 zone ID, enable external-dns.
        ...
        const bhojpurIngress = new KubernetesManifest(this, "bhojpur-ingress", {
            cluster,
            overwrite: true,
            manifest: [manifest],
        });

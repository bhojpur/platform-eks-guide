...
cp /etc/packer/files/bhojpur/containerd-stargz-grpc.toml /etc/containerd-stargz-grpc/config.toml
cp /etc/packer/files/bhojpur/stargz-snapshotter.service  /lib/systemd/system/stargz-snapshotter.service
